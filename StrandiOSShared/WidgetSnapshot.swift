...
public struct WidgetSnapshot: Codable, Equatable {
    ...
    static func resolveSuiteName(infoDictionary: [String: Any]) -> String {
        ...
        // Fork last-resort: match this build's App Group (com.ecmode.loop). Only reached if
        // AppGroupIdentifier is somehow absent — a proper build returns it at the case above.
        return "group.com.ecmode.loop"
    }
